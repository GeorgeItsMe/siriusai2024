# Дополнительная задача и MPV основного продукта для программы Сириус ИИ
...
1. Перейдите в директорию проекта:
   ```bash
   git clone https://github.com/yourusername/HotelRatingClassifier.git
2. Клонируйте репозиторий:
   ```
   cd HotelRatingClassifier
